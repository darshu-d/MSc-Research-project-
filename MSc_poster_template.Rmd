...
<div class="callout"> <h3>Why Multiple Outcomes Matter</h3> <ul class="small"> <li>**Clinical trials:** Win-ratio preserves the hierarchy of endpoints importance while combining the analysis of the affect.</li> <li>**Prediction:** Multi-state models can be used to model a process where subjects transition from one state to the next. And multi-task models are deep learning models which use common pathways to predict multi outcomes of interest.</li> </ul> </div>
