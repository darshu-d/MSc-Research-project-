...
/* ===============================
   MULTI-STATE DIAGRAM (DiagrammeR) – REMOVE SPACE
   =============================== */

/* Wrapper you will add around the diagram */
.ms-diagram{
  margin: 0 !important;
  padding: 0 !important;
}

/* DiagrammeR htmlwidget container adds whitespace */
...
```{r ms-diagram, results="asis", echo=FALSE, fig.height=1.0}
cat('<div class="ms-diagram">')

library(DiagrammeR)
grViz("
digraph ms {
  graph [rankdir = LR, nodesep=0.2, ranksep=0.25]
  node [shape=box, style=filled, fillcolor=white, penwidth=3, fontsize=14]
  edge [penwidth=3, arrowsize=1.0]
...
```{r km-os, echo=FALSE, fig.height=2.2, fig.width=6, out.width="100%"}
par(mar = c(3, 3, 1.1, 1))
