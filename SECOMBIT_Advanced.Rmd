...
* Huge decline in number of patients in **Stable** over time.

* Death increases over time.

* Progression is the intermediate state between these two.

Most patients transition from Stable to Death over time directly or via Progression state. Arm B shows higher HR of 2.56 from Stable to Death and the CI includes 1, which indicates no statistical significant effect on the treatment effect. No treatment arm shows significant impact on transition hazards.
...
* If starting Stable, 51% remain stable, 12.8% progress and 35.9% die.

* If starting Progression, 7.2% keeps progressing and 92.8% die.

**Arm B:**

* If starting Stable, 36% remain stable, 15.77% progress and 48.2% die.

* If starting Progression, 10% keeps progressing and 89.93% die.

**Arm C:**

* If starting Stable, 44% remain stable, 17% progress and 39% die.

* If starting Progression, 10% progress and 89.98% die.

**Conclusion:**

* Arm B has the largest probability of death and the lowest probability of remaining Stable. 

* Transition from Progression to Death is almost similar across all the Arms.

* This suggests treatment effect influence more before disease progression rather than after progression. 
...
```
##Plots - Probability of remaining Stable by Treatment
```{r}
...
* At the end of 6 months, Arm A has the highest probability of remaining stable(71%), following by Arm C (66%) and Arm B at 60%. Higher deaths are noted in Arm B (22%) and Arm A and Arm B shows less probability of deaths about 15% and 16%.

* There is a faster decline in probability of being stable in Arm B, which is followed by Arm C. Arm A shows slow decline in the probability of being stable over time.

* Only about 8% of probability of being stable was around 30 months in Arm B, where it was 19% in Arm A and 13% in Arm C. Arm A was still found to be superior.

* Arm A consistently shows highest probability of remaining Stable over time and lowest probability of Death at every time point.

* Arm B performs worst with rapid decline in probability of remaining Stable and highest mortality rate over time.

* Arm C shows intermediate outcomes between Arm A and Arm B.
