...
cox_comp_arm <- coxph(Surv(comp_time, os_status) ~ Arm,
                  data = clean_df, ties = "efron")
...
os_km_2 <- ggsurvplot(
  ...
  xlab = "Time (months)", ylab = "Survival probability",
  title = "Overall Survival (OS)",
  risk.table = FALSE, pval = TRUE, conf.int = TRUE, pval.coord = c(10,0.5), xlim = c(0,4), ylim = c(0.9,1.0),break.time.by = 1
)
...
pfs_km_2 <- ggsurvplot(
  ...
  xlab = "Time (months)", ylab = "Survival probability",
  title = "Progression-Free Survival (PFS)",
 risk.table = FALSE, pval = TRUE, conf.int = TRUE, pval.coord = c(10,0.2), xlim = c(0,4), ylim = c(0.9,1.0), break.time.by = 1
) 
