...
* Arm A has highest probability of remaining stable (~72%).

* Arm B has the lowest probability of remaining stable (~60%) and death is higher in this arm (~23%).

**At Time = 12:**

* Probability of remaining stable has reduced from 59% to 36% in Arm B.

* Still Arm A performs best with Arm C at intermediate.

**At Time = 24:**

* In Arm B, the probability of being Stable declined further to 12.9%

* Arm A performs better and Arm C still at intermediate.

**At Time = 30:**

* Arm A still performs better (18.8%) than Arm B and C.
...
* Arm A consistently shows better prognosis.

* Arm B declines over time with poor prognosis.

* Arm C is a sandwich between A and B.
