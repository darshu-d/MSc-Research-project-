...
\title{Methods for Handling Multiple Outcomes in Health Data}
...
\author{
  ...
  Galway, Ireland \\
  \texttt{\href{mailto:s.muthukumarasamy1@universityofgalway.ie}{\nolinkurl{s.muthukumarasamy1@universityofgalway.ie}}} \\
   \And
   ...
   \\
    ...
    University of Galway \\
  Galway, Ireland \\
  \texttt{\href{mailto:S.sreekanth1@universityofgalway.ie}{\nolinkurl{S.sreekanth1@universityofgalway.ie}}} \\
  }
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Another sample figure}]{Secombit_Report_files/figure-latex/fig2-1.pdf}}
